...
browser=Chrome()
browser.get('https://www.booz.cl/auth')
...
def RegistroC(): #Registro de cuenta con datos aleatorios en BO.
    pyautogui.click(507, 455) #clickea el botón de registro 
    usuarioBO = browser.find_element_by_id('input-register-username') #Obtiene id de usuario en la página
    escrituraD(usuarioBO, stringR()) # Ingresa un usuario aleatorio
